...
const config = {
    // Domain restriction
    allowedDomains: ['www.massageheaven.gr'],
    
    // Privacy policy URL (configurable)
    privacyPolicyUrl: 'https://www.massageheaven.gr/privacy-policy/', // Add your full privacy policy URL here
...
geoConfig: {
    ...
    transition: 'all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1) !important',
       ...
       accept: {
    background: '#c1a56d !important',
    color: '#ffffff !important',
    border: '1px solid #c1a56d !important',
    hover: {
        background: '#c1a56d !important',
        color: '#ffffff !important',
